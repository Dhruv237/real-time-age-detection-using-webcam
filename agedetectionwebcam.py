...
prototxtPath = 'C:/Users/Dell/deploy.prototext.txt'
weightsPath = 'C:/Users/Dell/res10_300x300_ssd_iter_140000.caffemodel'
faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)
# load our serialized age detector model from disk
print("[INFO] loading age detector model...")
prototxtPath = 'C:/Users/Dell/age_deploy.prototext.txt'
weightsPath = 'C:/Users/Dell/age_net.caffemodel'
    ...
    for (x, y, w, h) in faces:
        ...
        try:
           ...
           #     'C:/Users/Dell/' + str(w) + str(h) + '_faces.png')
            image=cv2.imread('C:/Users/Dell/' + str(w) + str(h) + '_faces.png')
            ...
            for i in range(0, detections.shape[2]):
                ...
                if confidence > args["confidence"]:
                    ...
                    (startX, startY, endX, endY) = box.astype("uint8")
